...
const Orders = async () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4 ">
      <div className="bg-white sm:p-8 rounded-xl shadow-lg w-full max-w-4xl">
                ...
                {order.amountDiscount ? (
                  <Fragment>
                    <div className="mt-4 sm:p-4 bg-red-50 rounded-lg ">
                      <p className="font-medium mb-1 text-sm sm:text-base text-red-600">
                        Discount Applied:{' '}
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      {order.products?.map((product) => (
                        ...
                        >
                          ...
                          <p className="font-medium text-right font-semibold">
